...
public class VistaFormularioRuta extends javax.swing.JFrame {
    ...
    /**
     * Creates new form VistaFormularioRuta
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaFormularioRuta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaFormularioRuta().setVisible(true);
            }
        });
    }
